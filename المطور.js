const handler = async (m, {conn, usedPrefix}) => {
  ...
  const text = `*—◉ الرقم الأول للمالك wa.me/994406674437*

  *—◉ الرقم التاني للمالك wa.me/994407254134*`.trim();
  const buttonMessage= {
...
handler.tags = ['info'];
handler.command = /^(owner|creator|creador|propietario|المالك|المطور)$/i;
